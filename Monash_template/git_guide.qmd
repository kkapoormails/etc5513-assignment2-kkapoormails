...
![Git status showing tracked and untracked files](images/git_status.png)
...
![Staging files by git add](images/git_add.png)
...
![Committing Changes Using git commit](images/git_commit.png)
...
![Pushing all the local changes with git push -u origin main](images/git_push.png)
...
![Sample Plot from example.qmd](images/plot.png)
...
At first, Git can feel like overkill for a simple project — but once you’ve used it properly, you wonder how you ever worked without it. From saving your progress to fixing mistakes and collaborating without chaos, Git takes the stress out of managing your work. This guide walked you through the basics, but the real power of Git shows up when things go wrong — and you’re able to stay calm, because Git’s got your back. Keep practicing, keep pushing, and soon this stuff will feel second nature.\
